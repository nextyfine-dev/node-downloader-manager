...
downloadManager.on("paused", (data) => console.log(data?.message, data?.url));
downloadManager.on("resumed", (data) => console.log(data?.message, data?.url));
downloadManager.on("cancel", (data) => console.log(data?.message, data?.url));
